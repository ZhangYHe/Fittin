...
The system MAY still expose the full set sequence, but it MUST appear as secondary context rather than the primary layout structure.
...
- **THEN** the main screen remains focused on set interaction and set progression even if no rest timer surface is present.
